...
public final class GlobalUtils {
	...
	/**
	 * @see will return integer value 0 if dates are equal, will return 1 if date1 is after date2
	 *      and will return -1 if date1 is before date2
	 * @param date1
	 * @param date2
	 * @return int
	 */
	...
	/**
	 * @see Will return dd-MM-yyyy format String date
	 * @param java.util.Date
	...
	/**
	 * @see Will return yyyy-MM-dd format String date
	 * @param java.util.Date
	 * @return java.lang.String
	 */
	
	public static String getSimpleSqlFormatDate() {
	 ...
	 * @param double
	 * @return String
	 * @see This method will convert and return any valid BigDecimal value into indian currency
	 *      format String.
	 */
